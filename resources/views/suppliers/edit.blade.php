...
@section('page_title', 'تعديل مورد')
@section('page_subtitle', 'تحديث بيانات المورد وأسعار الوقود')
...
<div class="modern-rtl-container">
    <div class="main-card">
        <div class="card-header-soft">
            <h4 class="fw-bold mb-1">تعديل المورد</h4>
            <p class="text-muted small mb-0">تحديث بيانات المورد وأسعار الوقود الخاصة به</p>
        </div>
        ...
        <form method="POST" action="{{ route('suppliers.update', $supplier->id) }}">
            ...
            <div class="form-section">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control-soft" value="{{ old('name', $supplier->name) }}" required>
                    </div>
                    <div class="col-md-6">
                        <label class="small fw-bold mb-2 d-block">رقم الجوال</label>
                        <input type="text" name="phone" class="form-control-soft" value="{{ old('phone', $supplier->phone) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="small fw-bold mb-2 d-block">الشخص المسؤول</label>
                        <input type="text" name="contact_person" class="form-control-soft" value="{{ old('contact_person', $supplier->contact_person) }}">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="notes" class="form-control-soft" rows="3">{{ old('notes', $supplier->notes) }}</textarea>
                    </div>
                </div>
                ...
                <div class="row mt-3 supplier-prices">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="prices[1]"
                            class="form-control bg-success-subtle text-success fw-bold border-success">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="prices[2]"
                            class="form-control bg-danger-subtle text-danger fw-bold border-danger">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="prices[3]"
                            class="form-control bg-warning-subtle text-dark fw-bold border-warning">
                    </div>
            ...
            <div class="actions-bar">
                <button type="submit" class="btn-modern btn-save">تحديث المورد</button>
