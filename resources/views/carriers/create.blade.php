...
@section('title', 'إضافة ناقل')
@section('page_title', 'إضافة ناقل')
@section('page_subtitle', 'إضافة ناقل جديد لاستخدامه في طلبات الوقود')
...
<div class="modern-rtl-container">
    <div class="main-card">
        <div class="card-header-soft">
            <h4 class="fw-bold mb-1">إضافة ناقل جديد</h4>
            <p class="text-muted small mb-0">أدخل بيانات الناقل ليظهر في طلبات الوقود</p>
        </div>
        ...
        <form method="POST" action="{{ route('carriers.store') }}">
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control-soft" value="{{ old('name') }}" placeholder="اسم الناقل" required>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="actions-bar">
                <button type="submit" class="btn-modern btn-save">حفظ الناقل</button>
